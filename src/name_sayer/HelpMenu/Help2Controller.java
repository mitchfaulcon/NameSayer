...
public class Help2Controller extends AbstractHelpController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            BufferedImage bufferedImage = ImageIO.read(new File("Resources/Settings.png"));
