...
public class Help3_1Controller extends AbstractHelpController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            BufferedImage bufferedImage = ImageIO.read(new File("Resources/PracticeMenu2.png"));
